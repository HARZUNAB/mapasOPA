...
Los tests viven en pruebas/mis_pruebas/ y están documentados aquí de forma
...
SALIDA = os.path.join(DIR, "INFORME_DETALLADO_MIS_TESTS_M1_M5.docx")
...
def main():
    ...
    doc.add_paragraph(
        "Los archivos viven en pruebas/mis_pruebas/ con prefijo test_m*.py y "
    ...
    for t in [
        "python3 -m pytest pruebas/mis_pruebas -v",
        "python3 -m pytest pruebas -v   (suite completa: 72 pruebas)",
    ]:
