...
Genera el material multimedia del curso de tests unitarios:
  ...
  - Diagramas (PNG)
  - Videos MP4 cortos (pruebas/CURSO_MEDIA/)

Requiere: Pillow, matplotlib (python del sistema) y ffmpeg en /usr/bin.
Ejecutar: python3 pruebas/generar_media_curso.py
"""
import os
import shutil
import subprocess
...
def main():
    ...
    cod_vacio = render_codigo(["# (archivo vacío: aquí nacerá tu primer test)"],
                              "/tmp/x.png", "pruebas/test_avance.py")
    cod_1 = render_codigo(["import capturar"], "/tmp/x.png", "pruebas/test_avance.py")
    cod_2 = render_codigo(
        ["import capturar", "",
    ...
    v2 = [cod_vacio, cod_1, cod_2, cod_3,
          render_terminal(["$ python3 -m pytest pruebas/test_avance.py -v", ""],
                          "/tmp/x.png"),
    ...
    fallo = render_codigo(
        ...
        "/tmp/x.png", "pruebas/test_fallo.py")
    v3 = [fallo,
          render_terminal(["$ python3 -m pytest pruebas/test_fallo.py -v", "",
          ...
          render_terminal(
              ["=================================== FAILURES ===================================",
               ...
               "=========================== short summary ============================",
               "FAILED pruebas/test_fallo.py::test_porcentaje_correcto - AssertionError"],
              "/tmp/x.png"),
          render_terminal(
    ...
    v4 = [feo,
          render_terminal(["$ black pruebas/", "",
                           "reformatted pruebas/test_demo.py",
                           "All done! ✨  1 file reformatted."],
                          "/tmp/x.png"),
          bello,
          render_terminal(["$ black --check fuentes/pruebas/",
                           "would reformat pruebas/test_demo.py",
    ...
    v5 = [gm.copy(),
          ...
          render_terminal(["$ python3 -m pytest pruebas/ -v", "",
