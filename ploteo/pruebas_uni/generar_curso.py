...
Las soluciones del laboratorio viven en SOLUCIONES y se usan para dos cosas:
  ...
  2) `python3 pruebas_uni/generar_curso.py --verificar` las ejecuta de verdad
     con pytest (en /tmp) para garantizar que lo publicado funciona.
...
SALIDA = os.path.join(MEDIA, "CURSO_TESTS_UNITARIOS.docx")
...
def construir(doc):
    ...
    tabla(
        ...
        ["Convención", "Regla"],
        [
            ["Ubicación", "pruebas_uni/ (junto a los tests existentes)"],
    ...
    doc.add_paragraph(
        ...
        "la clase BaseConsulta de pruebas_uni/IA_pruebas/test_consulta.py). En pytest se usa "
    ...
    codigo(doc, "cd ploteo\npython3 -m pytest pruebas_uni -v          # toda la carpeta\n"
                ...
                "python3 -m pytest pruebas_uni --tb=short       # tracebacks cortos")
    ...
    codigo(doc,
           ...
           "2. python3 -m pytest pruebas_uni/IA_pruebas/test_tuyo.py -v   → PASSED\n"
           "3. black pruebas_uni/IA_pruebas/test_tuyo.py          → formato uniforme\n"
           "4. agrega el docstring que explique qué protege el test\n"
           "5. python3 -m pytest pruebas_uni -v                → todo verde = listo")
    ...
    doc.add_paragraph(
        ...
        "cada archivo dentro de pruebas_uni/IA_pruebas/ con el nombre indicado. "
        "Al terminar cada "
    ...
    labs = [
        ("L1 — mostrar_avance (capturar.py)",
         "pruebas_uni/IA_pruebas/test_lab1_avance.py",
        ...
        ("L2 — contar_lineas (preprocesa_grillas.py)",
         "pruebas_uni/IA_pruebas/test_lab2_contar_lineas.py",
        ...
        ("L3 — inicializar_csv (capturar.py)",
         "pruebas_uni/IA_pruebas/test_lab3_inicializar_csv.py",
        ...
        ("L4 — lee_catalogo (lee_catalogo.py)",
         "pruebas_uni/IA_pruebas/test_lab4_lee_catalogo.py",
        ...
        ("L5 — ruta_datos (consulta_evento.py)",
         "pruebas_uni/IA_pruebas/test_lab5_ruta_datos.py",
        ...
        ("L6 — procesar_xyz (preprocesa_grillas.py)",
         "pruebas_uni/IA_pruebas/test_lab6_procesar_xyz.py",
    ...
    nota(doc, "cuando tus tests estén verdes, quedan integrados solos: pytest "
              "los descubre en pruebas_uni/ y, al regenerar el instalador "
              "(./crear_instalador.sh), la marcha blanca los correrá de ahí en "
              "adelante.")
